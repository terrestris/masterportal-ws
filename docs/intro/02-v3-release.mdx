...
import TimeSchedule from './img/Masterportal-TimeSchedule.svg';
...
**Ausgewählte Parameter:** ([vollständige Liste](https://www.masterportal.org/mkdocs/doc/v3.15.2/User/Portal-Config/config.json/#portalconfigmenusectionsmodulesabout))
